                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('route' => 'lines.store','class' => 'form-horizontal form-label-left')) !!}
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Node <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('node', null, ['required' => 'required', 'class' => 'form-control col-md-7 col-xs-12']) !!}
                                </div>
                            </div>
