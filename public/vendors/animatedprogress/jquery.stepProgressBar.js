...
(function ($){
    ...
    StepProgressBar.prototype = {
        ...
        _buildStep: function(step, index) {
            ...
            if(!isNullOrUndefined(step.color)) {
                step.stepElement.css('border-color', step.color);
            }
        },
        ...
        _buildTopLabel: function(step, index) {
            ...
            if(!isNullOrUndefined(step.color)) {
                step.topLabelElement.css('color', step.color);
            }
        ...
        _buildBottomLabel: function(step, index) {
            ...
            if(!isNullOrUndefined(step.color)) {
                step.bottomLabelElement.css('color', step.color);
            }
